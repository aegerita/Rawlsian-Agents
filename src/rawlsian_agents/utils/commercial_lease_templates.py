...
[TENANT NAME] [TENANT ORGANIZATION NUMBER] [TENANT ADDRESS]
...
more specifically defined below) for the continued purpose of [STATEMENT OF PURPOSE].

The [LANDLORD] has agreed to grant to the Tenant a lease of the Premises on the terms and
...
(a) “Environmental Laws” means any statutes, laws, regulations, orders, bylaws, standards,
...
(d) “Leasehold  Improvements”  means  all  fixtures,  improvements,  additions,  partitions,
...
(f) “Taxes” means all taxes, rates, charges, assessments and levies and other governmental
...
hereby  leases  to  the  Tenant  the  Premises.

3.0

TERM

The  Tenant  will  have  and  hold  the  Premises,  subject  to  the  rents,  covenants,  conditions  and agreements in this Lease, for a term of [TERM], commencing on the ___ day of
_______, ____, and ending on the _____ day of ___________, ___ (the “Term”), unless earlier
...
The  Tenant  will  use  the  Premises  for  the  purpose  of [STATEMENT OF PURPOSE], and for no other uses without the written consent of the Landlord.
...
Subject to Section 5.2, the Tenant will pay to the Landlord during the Term [AMOUNT] plus
all  applicable  taxes  per  annum  (the  “Rent”)  and  such  fee  shall  be  paid  to  the  Landlord [RENT CONDITIONS, e.g., monthly, quarterly, annually and the due date, etc.].
...
(a) The Tenant will promptly pay all Taxes and Utility Costs charged upon the Tenant or the
Landlord as they become due.

(b) The Tenant will provide to the Landlord, when and if requested by the Landlord, receipts
...
(a) The Tenant will, at all times during the Term, promptly repair, clean, renew, and maintain the
Premises  in  a  condition  that  is  safe  and  visually-acceptable  to  the  Landlord  including  all Buildings,  structures,  facilities,  landscaping, etc.

(b) The  Tenant  will  permit  the  Landlord  and  its  duly  authorized  agents  or nominees, with  or without  workers  and  others,  at  all  reasonable  times  to  enter  upon  the  Premises  for  the purpose of examining the state of repair, condition and use of them, and the Tenant will
repair and maintain, according to notice received from the Landlord within [PERIOD] days
...
(a) The Tenant will not construct or alter any buildings or structures on the Premises unless
such  construction  is  in  compliance with [APPLICABLE REGULATION]

(b) All construction or alteration of any buildings or structures on the Premises must conform
to  all  applicable  building  safety  and  health  standards  and  any  applicable  zoning
regulations  in  effect  in  the  jurisdiction  in  which  the  Premises  are  located,  and  must  be certified  as  conforming  thereto  by  a  qualified  professional  (for  example,  an  engineer  or architect).

(c) Any construction or alteration on the Premises carried out by the Tenant will be at the sole
cost of the Tenant.

(d) The Tenant will not perform or allow to be performed any construction or alteration on the
...
(a) do,  observe  and  perform  all  of  its  obligations  and  all  matters  and  things  necessary  or expedient to be done, observed or performed by the Tenant by virtue of any law, statute,
...
(b) ensure that its officers, employees and agents, and all persons using the Premises shall,
at all times during this Lease, observe and comply with the provisions and regulations, and any other law, statute, bylaw, ordinance, regulation or lawful  requirement  in  force  from  time  to  time  as  well  as  all  local rules pertaining to the Premises.

(c) comply promptly at its own expense with the requirements of all authorities, including an
...
discretion, and indemnify the Landlord from all claims, lawsuits, damages, losses, costs or expenses that the  Landlord  may  incur  by  reason  of  noncompliance  by  the  Tenant  with  any  of  the
requirements of this Section 6.7 or by reason of any defect in the Premises or any injury
...
(a) The Tenant will indemnify the Landlord from and against all manner of actions or causes
...
the  Landlord  may  sustain,  incur  or  be  put  to  by  reason  of  or  arising  out  of  any  act  or omission  of  the  Tenant  or  any  persons  for  whom  the  Tenant  is,  at  law,  responsible,  or from the use or occupation of the Premises, the Lands, or the Buildings, in whole or in part
...
or  other  authority,  or  any  of  the  covenants,  agreements,  terms,  conditions,  and  provisions
...
(a)The Landlord will not be liable for any personal injury, death or property loss or damage
...
(i) will  indemnify  the  Landlord  against  all  actions  or  liabilities  arising  out  of  such
...
(ii) hereby releases the Landlord and its officers, employees, agents, successors and
...
(c) increases the hazard of fire, dangerous condition, or liability of any kind, over and above
activities which are usually carried out by the Tenant in the normal course of its business or
...
(a) not  use  or  permit  to  be  used  all  or  any  part  of  the  Premises  for  the  sale,  storage, manufacture, disposal, use, or any other dealing with any Hazardous Substances, without
the prior written consent of the Landlord, which may be reasonably withheld;

(b) strictly comply, and cause any person for whom it is in law responsible to comply, with all
Environmental Laws regarding the use and occupancy of the Premises;

(c) promptly  provide  to  the  Landlord  a  copy  of  any  environmental  site  assessment,  audit  or report  relating  to  the  Premises  conducted  by  or  for  the  Tenant  at  any  time,  and,  at  the Landlord’s  request  from  time  to  time,  obtain  from  an  independent  environmental
...
(d) promptly  notify  the  Landlord  in  writing  of  any  release  of  a  Hazardous  Substance  or
...
(e) on  the  expiry  or  earlier  termination  of  this  Lease,  or  at  any  time  if  requested  by  the Landlord  or  required  by  any  government  authority  pursuant  to  Environmental  Laws,
...
whom  it  is  in  law  responsible.    The  Tenant  will  perform  these  obligations  promptly  at  its own  cost  and  in  accordance  with  Environmental  Laws.    All  such  Hazardous  Substances
...
(f) indemnify the Landlord and its officers, employees, agents, successors and assigns from
...
(i) any  breach  or  non-compliance  with  the  provisions  of  this  Section  6.14  by  the
Tenant; or

(ii) any  release  or  alleged  release  of  any  Hazardous  Substance  or  Hazardous
...
The obligations of the Tenant under this Section 6.14 will survive the expiry or earlier termination
of this Lease.
...
(a) The Tenant will use its best efforts to ensure that no claim of lien will be filed in respect of
...
within [PERIOD] of the date the Tenant has knowledge of such filing.

(b) The Tenant will indemnify and save harmless the Landlord from and against any and all
loss,  cost,  expense,  damage  and  liability  in  respect  of  any  claims  for  liens  for  wages  or materials  or  for  damage  to  persons  or  property  caused  during  the  making  of  or  in
...
(c) The Landlord, in addition to any right or remedy, will have the right, but will not be obliged,
...
decoration of the Premises or any part of them and such default continues for [TIME PERIOD]
after notice in writing from the Landlord of default in respect of repair, maintenance,
...
on _____ days notice, and repair, clean, renew, and maintain them at the expense of the
...
(i) in doing the repairs, maintenance, cleaning, renewing or maintaining, the Landlord
may  bring  and  leave  upon  the  Premises  all  necessary  materials,  tools  and
equipment; and

(ii) the  Landlord  will  not  be  liable  to  the  Tenant  for  any  inconvenience,  annoyance,
...
(b) Nothing in this Agreement will require the Landlord to directly or indirectly commence or
...
is  liable  under  this  Lease,  then  the  Landlord  may  at  its  option  add  the  cost  or  amount  of  the damage, loss, expense or payment to the Rent and may recover it by all remedies available to the Landlord for the recovery for Rent in arrears.

8.3

Fitness of Premises

(a) The  Landlord  has  made  no  representations  or  warranties  as  to  the  condition,  fitness  or nature  of  the  Premises,  including,  without  limitation,  the  environmental  condition  of  the Premises  and  the  Tenant’s  ability  to  use  the  Premises  for  its  intended  uses,  and  by
...
(b) The Tenant has inspected the Premises and has satisfied itself that they are suitable for
the Tenant’s purposes.

(c) The  Landlord  or  any  person  designated  by  the  Landlord  shall  have  the  right  at  all
...
fire,  lightning,  or  tempest,  or  any  other  peril  so  as  to  render  them  unfit  for  the  purposes  of  the Tenant:
...
(b) at the option of the Landlord, if the Premises are not rebuilt or made fit for the purpose of
the  Tenant  within ___  days,  the  Term  shall  end  and  the  Tenant  shall  not  be
...
Rent will be payable in advance on the [DEFINED DUE DATE] during such overholding
period, equal to [DEFINED OVERHOLDING RENT], and in addition the Tenant will be liable for all costs, expenses, losses and damages
...
(a) any amount due from the Tenant to the Landlord under this Lease is in arrears and is not
paid within _______ (___) days after written demand by the Landlord;

(b) the  Tenant  has  breached  any  of  its  obligations  under  this  Lease,  other  than  payment  of any amounts due from the Tenant, and after _______ (___) days notice in writing from
the  Landlord,  the  Tenant  fails  to  remedy  such  breach  or,  in  the  case  of  a  failure  which cannot with due diligence be cured within such _______ (___) day period, if the Tenant
...
such _______ (___) day period that the time within which the Tenant shall have to cure
the same shall be extended for such period as may be reasonably necessary to cure the
same with diligence;

(c) a creditor of the Tenant executes or attaches the Lease or any of the goods and chattels,
improvements or fixtures erected or placed by the Tenant in or upon the Premises and the
same is not stayed within _______ (___) days;

(d) the  Tenant  makes  any  assignment  for  the  benefit  of  creditors,  or  becomes  insolvent  or
bankrupt or ceases to function or proceedings are commenced to wind up the Tenant;

(e) a  liquidator  or  a  receiver  or  a  trustee  in  bankruptcy  is  appointed  for  or  in  relation  to  the Tenant  under  Bankruptcy  and  Insolvency   or  any  law thereof  relating  to
bankruptcy or insolvency if such appointment is not vacated or terminated within _______ (___) days or stayed on appeal;
...
(a) No waiver of any provision of this Lease is binding unless it is in writing and signed by the
party having rights under, or holding the benefit of, the provision being waived.

(b) No failure to exercise or delay in exercising any remedy under this Lease will be deemed
to be a waiver of the right or remedy.

(c) No waiver of any breach of any provision of this Lease will be deemed to be a waiver of
any subsequent breach of that provision or of any similar provision.

(d) A  termination  of  this  Lease  by  the  Landlord  will  not  be  deemed  to  be  a  waiver  or
...
accrue  on  a  daily  basis  at [INTEREST RATE]% per annum, calculated from the date the money is due until the date it is paid in full.
